...
public class PlayerMovement : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
        ...
        */
		...
		body.position = new Vector2 (Mathf.Clamp (body.position.x, Boundary.xMin, Boundary.xMax), body.position.y);
	...
	void OnTriggerEnter2D (Collider2D other)
	{
		if (other.tag == "Pearl") {
			...
			ScoreManager.instance.UpdatePearls (other.GetComponent<Mover> ().num);
		}
	}
